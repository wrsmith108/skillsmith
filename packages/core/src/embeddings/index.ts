 ...
 * SMI-642: VectorStore for SQLite-based vector storage
...
// Re-export VectorStore and similarity utilities
export { VectorStore, VectorStoreValidationError, VectorStoreBatchError } from './VectorStore.js'
export type {
  VectorEntry,
  SimilarityMatch,
  VectorStoreOptions,
...
// Re-export similarity utilities for direct use
export {
  cosineSimilarity,
  euclideanDistance,
  dotProduct,
