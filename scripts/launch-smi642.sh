#!/bin/bash
# Launch focused session for SMI-642: Vector Embeddings
...
PROMPT_FILE="$SCRIPT_DIR/prompts/smi642-vector-embeddings.md"
...
echo "┌─────────────────────────────────────────────┐"
echo "│  SMI-642: Vector Embeddings for Search      │"
echo "├─────────────────────────────────────────────┤"
echo "│  Files to create:                           │"
echo "│  1. embeddings/EmbeddingService.ts          │"
echo "│  2. embeddings/VectorStore.ts               │"
echo "│  3. embeddings/index.ts                     │"
echo "│  4. tests/EmbeddingService.test.ts          │"
echo "│  5. Update SearchService.ts                 │"
echo "├─────────────────────────────────────────────┤"
echo "│  After EACH file: npm run typecheck         │"
echo "│  Progress: /tmp/smi642-progress.log         │"
echo "└─────────────────────────────────────────────┘"
echo ""
